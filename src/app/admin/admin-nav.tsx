...
export function AdminNav({ publicMenuHref }: { publicMenuHref?: string }) {
  ...
  const links = [{ href: "/admin", label: "Resumen" }, { href: "/admin/categories", label: "Categorías" }, { href: "/admin/items", label: "Platos" }, { href: "/admin/settings", label: "Cartas" }, { href: "/admin/users", label: "Equipo" }];
